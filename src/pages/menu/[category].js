import { useGetMenuQuery } from '@/apiRtk/apis/menuApi';
...
const menus = () => {
  ...
  const { data: dataGetMenu, error: errorGetMenu, isLoading: isLoadingGetMenu } = useGetMenuQuery({ category: category, page: 1 });
